...
const SideBar = () => {
  ...
  return (
    <div className=" hidden lg:block left-0 min-h-screen mt-4 basic  p-3 space-y-2 w-60 dark:bg-gray-50 dark:text-gray-800">
      <div className="flex items-center p-2 space-x-4">
        ...
        <div>
          ...
          <span className="flex items-center space-x-1">
            <p className="text-xs hover:underline dark:text-gray-600">
              Available
            </p>
          </span>
        </div>
