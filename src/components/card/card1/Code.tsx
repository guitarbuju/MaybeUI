      ...
      <div className=" flex flex-col md:grid md:grid-cols-3 lg:flex-row gap-6 lg:justify-around ">
        <div className="p-2    bg-gray-600 flex justify-center">
          <div className="max-w-xs p-6 rounded-md shadow-md bg-gray-900 text-gray-50">
            <img
              src="https://images.unsplash.com/photo-1730216597753-1b8ac897bcc5?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw0fHx8ZW58MHx8fHx8"
              alt=""
              className="object-cover object-center w-full rounded-md h-72 "
            />
            <div className="mt-6 mb-2 overflow-hidden md:text-xs">
        ...
        {/* Card2 /////////////////////////////////////////////////////////// */}
        <div className="flex flex-col max-w-[320px] max-h-[520px] p-6 border border-gray-600 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-900 text-gray-50 text-xs">
          <div className="flex space-x-4">
            <Image
              width={50}
              height={50}
              alt=""
              src="https://images.unsplash.com/photo-1711030241071-6cbf0803a7f7"
            ...
            <div className="flex flex-col space-y-1">
              ...
              <span className=" dark:text-gray-600">4 hours ago</span>
            </div>
          </div>
          <div className="text-xs overflow-hidden">
            <Image
              alt=""
              src="https://images.unsplash.com/photo-1715615685666-882710b534f9"
              className="object-cover w-full mb-4 h-40 sm:h-60 rounded-md"
              width={100}
              height={100}
            />
          ...
          <div className="flex flex-wrap justify-between ">
            ...
            <div className="flex space-x-2 text-sm text-gray-600 -mt-4">
              <button
                type="button"
        ...
        {/* card3/////////////////////////////////////////////////////////// */}
        <div className="p-2  bg-gray-600 flex justify-center">
        <div className="max-w-xs rounded-md shadow-md bg-gray-900 text-gray-50">
          <img
